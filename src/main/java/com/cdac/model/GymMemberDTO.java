...
public class GymMemberDTO {
	...
	public GymMemberDTO(int memberId, String gender, double height, Date joinDate, Date endDate, double weight,
			int subplanId, int user_id) {
	...
	public String toString() {
		return "GymMemberDTO [memberId=" + memberId + ", gender=" + gender + ", height=" + height + ", joinDate="
				+ joinDate + ", endDate=" + endDate + ", weight=" + weight + ", subplanId=" + subplanId + ", user_id="
				+ user_id + "]";
	}
